...
| `createModel` | Mutation | `createAiModelConfigResDtos` |  |
...
| `deleteModel` | Mutation | `deleteAiModelConfigResDtos` |  |
| `draftBatch_Execute` | Query | `getDraftBatchResDtos` |  |
| `exportRosterCsv_Execute` | Query | `exportRosterCsvResDtos` |  |
| `exportWeeklyReport_Execute` | Query | `exportWeeklyReportResDtos` |  |
...
| `listModels` | Query | `listAiModelConfigResDtos` |  |
...
| `pkPlayerStatsView` | Query | `pkPlayerStatsViews` |  |
| `PkPlayerStatsView_aggregate` | Query | `pkPlayerStatsViewAggregates` |  |
| `pkResult_Execute` | Query | `getPkResultResDtos` |  |
| `pkStats_Execute` | Query | `getPkStatsResDtos` |  |
| `preprocessContent_Execute` | Query | `preprocessContentResDtos` |  |
...
| `setEnabled` | Query | `setEnabledResDtos` |  |
...
| `updateModel` | Mutation | `updateAiModelConfigResDtos` |  |
