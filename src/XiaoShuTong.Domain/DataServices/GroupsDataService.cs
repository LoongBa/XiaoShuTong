...
/// <summary>数据服务：&#x7FA4;&#x7EC4;&#xFF08;&#x7FA4;&#x4E3B;&#x7BA1;&#x7406;&#xFF09;</summary>
// 提示：标准 CRUD 逻辑和构造函数已由 GroupsDataService.g.cs 承载。
...
// - 不要手动创建 Controller 类（V3.7 起由 SG 自动生成）
 partial class GroupsDataService(IDomainUser user, IEntityDAC<Groups> dac)
        : DomainDataServiceBase<Groups, GroupsDto>(user, dac, hasSoftDelete:false) 
{
