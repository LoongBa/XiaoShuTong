...
/// <summary>数据服务：&#x7FA4;&#x7EC4;&#x6210;&#x5458;&#xFF08;&#x5B66;&#x751F;/&#x5BB6;&#x957F;&#xFF09;</summary>
// 提示：标准 CRUD 逻辑和构造函数已由 GroupMembersDataService.g.cs 承载。
...
// - 不要手动创建 Controller 类（V3.7 起由 SG 自动生成）
 partial class GroupMembersDataService(IDomainUser user, IEntityDAC<GroupMembers> dac)
        : DomainDataServiceBase<GroupMembers, GroupMembersDto>(user, dac, hasSoftDelete:false) 
{
