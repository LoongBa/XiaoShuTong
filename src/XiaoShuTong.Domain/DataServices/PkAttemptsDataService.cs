...
/// <summary>数据服务：PK &#x7B54;&#x9898;&#x660E;&#x7EC6;&#xFF08;&#x9632;&#x91CD;&#x590D;&#x63D0;&#x4EA4;&#xFF1A;MatchId&#x2B;PlayerId&#x2B;QuestionId &#x552F;&#x4E00;&#xFF09;</summary>
// 提示：标准 CRUD 逻辑和构造函数已由 PkAttemptsDataService.g.cs 承载。
...
// - 不要手动创建 Controller 类（V3.7 起由 SG 自动生成）
 partial class PkAttemptsDataService(IDomainUser user, IEntityDAC<PkAttempts> dac)
        : DomainDataServiceBase<PkAttempts, PkAttemptsDto>(user, dac, hasSoftDelete:false) 
{
