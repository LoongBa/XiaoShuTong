...
/// <summary>数据服务：&#x9519;&#x9898;&#x672C;&#xFF08;&#x7269;&#x5316;&#x6D3E;&#x751F;&#x8868;&#xFF0C;&#x4E00;&#x4EBA;&#x4E00;&#x9898;&#x4E00;&#x884C;&#xFF09;</summary>
// 提示：标准 CRUD 逻辑和构造函数已由 WrongQuestionsDataService.g.cs 承载。
...
// - 不要手动创建 Controller 类（V3.7 起由 SG 自动生成）
 partial class WrongQuestionsDataService(IDomainUser user, IEntityDAC<WrongQuestions> dac)
        : DomainDataServiceBase<WrongQuestions, WrongQuestionsDto>(user, dac, hasSoftDelete:false) 
{
