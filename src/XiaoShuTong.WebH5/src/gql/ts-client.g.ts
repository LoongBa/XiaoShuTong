...
// Auto-generated GraphQL input type declarations for named-operation arguments.
// Used by Use()/Call() proxy to declare variable types (HotChocolate compliance).
export const operationVariableTypes: Record<string, Record<string, string>> = {
  'acceptBuddyInvite_Execute': { 'request': 'AcceptBuddyInviteReqDtoInput' },
  'activateMember_Execute': { 'request': 'ActivateMemberReqDtoInput' },
  'bankDetail_Execute': { 'request': 'GetBankDetailReqDtoInput' },
  'buddyRank_Execute': { 'request': 'GetBuddyRankReqDtoInput' },
  'cancelSubscription_Execute': { 'request': 'CancelSubscriptionReqDtoInput' },
  'changePasswordSecure': { 'input': 'ChangePasswordSecureInput' },
  'createBank_Execute': { 'request': 'CreateBankReqDtoInput' },
  'createGroup_Execute': { 'request': 'CreateGroupReqDtoInput' },
  'createModel': { 'request': 'CreateAiModelConfigReqDtoInput' },
  'createParentRelation_Execute': { 'request': 'CreateParentRelationReqDtoInput' },
  'createPkMatch_Execute': { 'request': 'CreatePkMatchReqDtoInput' },
  'createStudySession_Execute': { 'request': 'CreateStudySessionReqDtoInput' },
  'createTask_Execute': { 'request': 'CreateTaskReqDtoInput' },
  'dashboardReport_Execute': { 'request': 'GetDashboardReportReqDtoInput' },
  'deleteModel': { 'request': 'DeleteAiModelConfigReqDtoInput' },
  'draftBatch_Execute': { 'request': 'GetDraftBatchReqDtoInput' },
  'endStudySession_Execute': { 'request': 'EndStudySessionReqDtoInput' },
  'exportRosterCsv_Execute': { 'request': 'ExportRosterCsvReqDtoInput' },
  'exportWeeklyReport_Execute': { 'request': 'ExportWeeklyReportReqDtoInput' },
  'generateInviteCodes_Execute': { 'request': 'GenerateInviteCodesReqDtoInput' },
  'heatmap_Execute': { 'request': 'GetHeatmapReqDtoInput' },
  'hint_Execute': { 'request': 'GetHintReqDtoInput' },
  'importBankJson_Execute': { 'request': 'ImportBankJsonReqDtoInput' },
  'importQuestions_Execute': { 'request': 'ImportQuestionsReqDtoInput' },
  'importRoster_Execute': { 'request': 'ImportRosterReqDtoInput' },
  'inviteBuddy_Execute': { 'request': 'InviteBuddyReqDtoInput' },
  'joinPkMatch_Execute': { 'request': 'JoinPkMatchReqDtoInput' },
  'knowledgeCard_Execute': { 'request': 'GetKnowledgeCardReqDtoInput' },
  'listBanks_Execute': { 'request': 'ListBanksReqDtoInput' },
  'listGroups_Execute': { 'request': 'ListGroupsReqDtoInput' },
  'listModels': { 'request': 'ListAiModelConfigReqDtoInput' },
  'listMyTasks_Execute': { 'request': 'ListMyTasksReqDtoInput' },
  'listTasks_Execute': { 'request': 'ListTasksReqDtoInput' },
  ...
  'ownerDashboard_Execute': { 'request': 'GetOwnerDashboardReqDtoInput' },
  'periodReport_Execute': { 'request': 'GetPeriodReportReqDtoInput' },
  'pkPlayerStatsView': { 'first': 'Int', 'after': 'String', 'last': 'Int', 'before': 'String', 'where': 'PkPlayerStatsViewFilterInput', 'order': '[PkPlayerStatsViewSortInput!]' },
  'PkPlayerStatsView_aggregate': { 'where': 'PkPlayerStatsViewFilterInput' },
  'pkResult_Execute': { 'request': 'GetPkResultReqDtoInput' },
  'pkStats_Execute': { 'request': 'GetPkStatsReqDtoInput' },
  'preprocessContent_Execute': { 'request': 'PreprocessContentReqDtoInput' },
  'progressReport_Execute': { 'request': 'GetProgressReportReqDtoInput' },
  'rankings_Execute': { 'request': 'GetRankingsReqDtoInput' },
  'registerSecure': { 'input': 'RegisterSecureInput' },
  'rejectBuddyInvite_Execute': { 'request': 'RejectBuddyInviteReqDtoInput' },
  'removeBuddy_Execute': { 'request': 'RemoveBuddyReqDtoInput' },
  'removeMember': { 'request': 'RemoveMemberReqDtoInput' },
  'requestChallenge': { 'userName': 'String' },
  'reviewBackingPoints_Execute': { 'request': 'ReviewBackingPointsReqDtoInput' },
  'reviewQueue_Execute': { 'request': 'GetReviewQueueReqDtoInput' },
  'rosterPreview_Execute': { 'request': 'GetRosterPreviewReqDtoInput' },
  'sessionQuestion_Execute': { 'request': 'GetSessionQuestionReqDtoInput' },
  'sessionResult_Execute': { 'request': 'GetSessionResultReqDtoInput' },
  'setEnabled': { 'request': 'SetEnabledReqDtoInput' },
  'setRankEnabled_Execute': { 'request': 'SetRankEnabledReqDtoInput' },
  'startTrial_Execute': { 'request': 'StartTrialReqDtoInput' },
  'submitAttempt_Execute': { 'request': 'SubmitAttemptReqDtoInput' },
  'submitJudgmentFeedback_Execute': { 'request': 'SubmitJudgmentFeedbackReqDtoInput' },
